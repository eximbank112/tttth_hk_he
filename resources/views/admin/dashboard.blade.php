...
<head>
	...
	<!-- //calendar -->
	<!-- //font-awesome icons -->
	<script src="./back-end/js/jquery2.0.3.min.js"></script>
				...
				<div class="leftside-navigation">
					<ul class="sidebar-menu" id="nav-accordion">
						...
						<li class="sub-menu">
							...
							<ul class="sub">
								<li><a href="/management-order">Management Order</a></li>
							</ul>
						</li>
						<li class="sub-menu">
							<a href="javascript:;">
							...
							<ul class="sub">
								...
								<li><a href="/show-coupon">List Coupon</a></li>
							</ul>
						</li>
						<li class="sub-menu">
							<a href="javascript:;">
							...
							<ul class="sub">
								...
								<li><a href="/show-category">Show Category</a></li>
							</ul>
						</li>
						<li class="sub-menu">
							<a href="javascript:;">
